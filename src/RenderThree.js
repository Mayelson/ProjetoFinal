		...
		var player = { width:60, height:8, speed:1.8, turnSpeed:Math.PI*0.05 };
		var options = null;
		...
		function init() {
			...
			// console.log("document.getElementById(area)", document.getElementById("area"));
			// dataGui = new dat.GUI();
			// var elementDataGui = dataGui.domElement;
			// elementDataGui.id = "gui";
			// console.log("duidata", elementDataGui);
			// var area = document.getElementById("area");
			// area.append(elementDataGui);

			// elementDataGui.style.width = "100%"; 
			// // elementDataGui.style.max-width = "100%"; 
			// elementDataGui.style.display = "block"; 
			// elementDataGui.style.margin.right = "50px"; 

			// document.getElementById("area").append(renderer.domElement);
			// var elementCanvas = document.getElementsByTagName("canvas")[0];
			// elementCanvas.id = "idCanvas";
		...
		function guiData() {
			...
			audio.add(options.audio, 'play').onChange(function(){
				if (sound.isPlaying) {
			     sound.stop();
				}else{
			     sound.play();
